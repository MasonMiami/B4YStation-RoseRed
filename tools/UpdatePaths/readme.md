...
There are also a bunch of neat features you can use with UpdatePaths variable filtering, with it all documented here: (https://github.com/TheShopOfLongmont/B4YStation-RoseRed/blob/master/tools/UpdatePaths/\_\_main\_\_.py#L9)[https://github.com/TheShopOfLongmont/B4YStation-RoseRed/blob/master/tools/UpdatePaths/__main__.py#L9]. However, let's spin it all out for you here as well:
